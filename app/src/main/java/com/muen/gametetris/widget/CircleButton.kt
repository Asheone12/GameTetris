package com.muen.gametetris.widget
...
class CircleButton(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private val pressedColor = R.color.colorPrimaryVariant // Colour when pressed
    private var unpressedColor = R.color.colorOnPrimary // Colour when not pressed
