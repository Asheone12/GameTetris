...
import com.muen.gametetris.game.event.CollisionEventArgs
import com.muen.gametetris.game.event.Event
import com.muen.gametetris.game.event.GridChangedEventArgs
import com.muen.gametetris.game.event.LinesCompletedEventArgs
import com.muen.gametetris.game.event.TetrominoCoordinatesChangedEventArgs
import com.muen.gametetris.game.event.TetrominoSpawnedEventArgs
import com.muen.gametetris.settings.K_DROP_SPEED
import com.muen.gametetris.settings.K_GAME_LEVEL
import com.muen.gametetris.settings.K_GRID
import com.muen.gametetris.settings.K_LINES
import com.muen.gametetris.settings.K_TETROMINO
import com.muen.gametetris.settings.K_TETROMINO_COORDINATES
import com.muen.gametetris.settings.K_TETROMINO_ROTATION
import com.muen.gametetris.settings.K_UPCOMING_TETROMINOES
...
class Game(private val options: TetrisOptions = TetrisOptions(), val savedState: Bundle? = null) {
    ...
    internal fun move(direction: Direction) {
        ...
        eventDispatcher.dispatch(
            Event.TetrominoCoordinatesChanged,
